...
int main(int argc, char* argv[]){
	...
	// Example invocation to set the gpudevice.
	// Setting gpudevice to -1 indicates setaffinity_for_nvidia should choose the gpudevice number.
	int setaffinity_for_nvidia(int, int, int);
	int gpudevice= setaffinity_for_nvidia(my_rank, 6, -1);
